  ...
  const quickActions = [
    {
      ...
      description: "Begin attendance check",
      icon: ClipboardCheck,
      action: "start-rollcall",
      variant: "default" as const,
    },
    {
      title: "View Student Locations",
      description: "See where students are",
      icon: MapPin,
    ...
    },
    {
      ...
      description: "Review student messages",
      icon: MessageCircle,
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage roll calls, student locations, and communications
          </p>
        </div>
        <Badge
          variant="outline"
              ...
              <Button
                ...
                onClick={() => {
                  switch (action.action) {
                    case "start-rollcall":
                      navigate("/instructor/roll-call");
                      break;
                    case "view-locations":
                      navigate("/instructor/student-locations");
                      break;
                    case "check-messages":
                      navigate("/instructor/messages");
                      break;
                    case "approve-leaves":
                      navigate("/instructor/leave-requests");
                      break;
                    default:
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="card-enhanced">
          <CardHeader>
            ...
            <CardDescription>
              Attendance status for your classes
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              {recentRollCalls.map((rollCall, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    {rollCall.status === "in-progress" && (
                      <Clock className="h-4 w-4 text-warning" />
                    )}
                    {rollCall.status === "pending" && (
                  ...
                  <div className="text-right">
                    <p className="font-medium">
                      {rollCall.present}/{rollCall.total}
                    </p>
                    <Badge
                      variant={
                        rollCall.status === "completed"
        ...
        <Card className="card-enhanced">
          <CardHeader>
            ...
            <CardDescription>
              Student requests awaiting your approval
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
